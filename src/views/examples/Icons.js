                ...
                <Row className="icon-examples">
                  ...
                  <Col lg="3" md="6">
                    <CopyToClipboard
                      ...
                      onCopy={() =>
                        setCopiedText("ni ni-air-baloon")
                      }
                    >
                      <button
                        className="btn-icon-clipboard"
                  ...
                  <Col lg="3" md="6">
                    <CopyToClipboard
                      ...
                      onCopy={() =>
                        setCopiedText("ni ni-align-center")
                      }
                    >
                      <button
                        className="btn-icon-clipboard"
                  ...
                  <Col lg="3" md="6">
                    <CopyToClipboard
                      text={"ni ni-left-2"}
                      onCopy={() =>
                        setCopiedText("ni ni-align-left-2")
                      }
                    >
                      <button
                        className="btn-icon-clipboard"
                  ...
                  <Col lg="3" md="6">
                    <CopyToClipboard
                      ...
                      onCopy={() =>
                        setCopiedText("ni ni-bold-right")
                      }
                    >
                      <button
                        className="btn-icon-clipboard"
                  ...
                  <Col lg="3" md="6">
                    <CopyToClipboard
                      ...
                      onCopy={() =>
                        setCopiedText("ni ni-book-bookmark")
                      }
                    >
                      <button
                        className="btn-icon-clipboard"
                  ...
                  <Col lg="3" md="6">
                    <CopyToClipboard
                      ...
                      onCopy={() =>
                        setCopiedText("ni ni-briefcase-24")
                      }
                    >
                      <button
                        className="btn-icon-clipboard"
                  ...
                  <Col lg="3" md="6">
                    <CopyToClipboard
                      ...
                      onCopy={() =>
                        setCopiedText("ni ni-bus-front-12")
                      }
                    >
                      <button
                        className="btn-icon-clipboard"
                  ...
                  <Col lg="3" md="6">
                    <CopyToClipboard
                      ...
                      onCopy={() =>
                        setCopiedText("ni ni-button-pause")
                      }
                    >
                      <button
                        className="btn-icon-clipboard"
                  ...
                  <Col lg="3" md="6">
                    <CopyToClipboard
                      ...
                      onCopy={() =>
                        setCopiedText("ni ni-button-play")
                      }
                    >
                      <button
                        className="btn-icon-clipboard"
                  ...
                  <Col lg="3" md="6">
                    <CopyToClipboard
                      ...
                      onCopy={() =>
                        setCopiedText("ni ni-button-power")
                      }
                    >
                      <button
                        className="btn-icon-clipboard"
                  ...
                  <Col lg="3" md="6">
                    <CopyToClipboard
                      ...
                      onCopy={() =>
                        setCopiedText("ni ni-caps-small")
                      }
                    >
                      <button
                        className="btn-icon-clipboard"
                  ...
                  <Col lg="3" md="6">
                    <CopyToClipboard
                      ...
                      onCopy={() =>
                        setCopiedText("ni ni-chart-bar-32")
                      }
                    >
                      <button
                        className="btn-icon-clipboard"
                  ...
                  <Col lg="3" md="6">
                    <CopyToClipboard
                      ...
                      onCopy={() =>
                        setCopiedText("ni ni-chart-pie-35")
                      }
                    >
                      <button
                        className="btn-icon-clipboard"
                  ...
                  <Col lg="3" md="6">
                    <CopyToClipboard
                      ...
                      onCopy={() =>
                        setCopiedText("ni ni-chat-round")
                      }
                    >
                      <button
                        className="btn-icon-clipboard"
                  ...
                  <Col lg="3" md="6">
                    <CopyToClipboard
                      ...
                      onCopy={() =>
                        setCopiedText("ni ni-check-bold")
                      }
                    >
                      <button
                        className="btn-icon-clipboard"
                  ...
                  <Col lg="3" md="6">
                    <CopyToClipboard
                      ...
                      onCopy={() =>
                        setCopiedText("ni ni-compass-04")
                      }
                    >
                      <button
                        className="btn-icon-clipboard"
                  ...
                  <Col lg="3" md="6">
                    <CopyToClipboard
                      ...
                      onCopy={() =>
                        setCopiedText("ni ni-controller")
                      }
                    >
                      <button
                        className="btn-icon-clipboard"
                  ...
                  <Col lg="3" md="6">
                    <CopyToClipboard
                      ...
                      onCopy={() =>
                        setCopiedText("ni ni-credit-card")
                      }
                    >
                      <button
                        className="btn-icon-clipboard"
                  ...
                  <Col lg="3" md="6">
                    <CopyToClipboard
                      ...
                      onCopy={() =>
                        setCopiedText("ni ni-curved-next")
                      }
                    >
                      <button
                        className="btn-icon-clipboard"
                  ...
                  <Col lg="3" md="6">
                    <CopyToClipboard
                      ...
                      onCopy={() =>
                        setCopiedText("ni ni-delivery-fast")
                      }
                    >
                      <button
                        className="btn-icon-clipboard"
                  ...
                  <Col lg="3" md="6">
                    <CopyToClipboard
                      ...
                      onCopy={() =>
                        setCopiedText("ni ni-fat-delete")
                      }
                    >
                      <button
                        className="btn-icon-clipboard"
                  ...
                  <Col lg="3" md="6">
                    <CopyToClipboard
                      ...
                      onCopy={() =>
                        setCopiedText("ni ni-fat-remove")
                      }
                    >
                      <button
                        className="btn-icon-clipboard"
                  ...
                  <Col lg="3" md="6">
                    <CopyToClipboard
                      ...
                      onCopy={() =>
                        setCopiedText("ni ni-favourite-28")
                      }
                    >
                      <button
                        className="btn-icon-clipboard"
                  ...
                  <Col lg="3" md="6">
                    <CopyToClipboard
                      ...
                      onCopy={() =>
                        setCopiedText("ni ni-headphones")
                      }
                    >
                      <button
                        className="btn-icon-clipboard"
                  ...
                  <Col lg="3" md="6">
                    <CopyToClipboard
                      ...
                      onCopy={() =>
                        setCopiedText("ni ni-mobile-button")
                      }
                    >
                      <button
                        className="btn-icon-clipboard"
                  ...
                  <Col lg="3" md="6">
                    <CopyToClipboard
                      ...
                      onCopy={() =>
                        setCopiedText("ni ni-money-coins")
                      }
                    >
                      <button
                        className="btn-icon-clipboard"
                  ...
                  <Col lg="3" md="6">
                    <CopyToClipboard
                      ...
                      onCopy={() =>
                        setCopiedText("ni ni-paper-diploma")
                      }
                    >
                      <button
                        className="btn-icon-clipboard"
                  ...
                  <Col lg="3" md="6">
                    <CopyToClipboard
                      ...
                      onCopy={() =>
                        setCopiedText("ni ni-ruler-pencil")
                      }
                    >
                      <button
                        className="btn-icon-clipboard"
                  ...
                  <Col lg="3" md="6">
                    <CopyToClipboard
                      ...
                      onCopy={() =>
                        setCopiedText("ni ni-sound-wave")
                      }
                    >
                      <button
                        className="btn-icon-clipboard"
                  ...
                  <Col lg="3" md="6">
                    <CopyToClipboard
                      ...
                      onCopy={() =>
                        setCopiedText("ni ni-square-pin")
                      }
                    >
                      <button
                        className="btn-icon-clipboard"
                  ...
                  <Col lg="3" md="6">
                    <CopyToClipboard
                      ...
                      onCopy={() =>
                        setCopiedText("ni ni-support-16")
                      }
                    >
                      <button
                        className="btn-icon-clipboard"
                  ...
                  <Col lg="3" md="6">
                    <CopyToClipboard
                      ...
                      onCopy={() =>
                        setCopiedText("ni ni-tablet-button")
                      }
                    >
                      <button
                        className="btn-icon-clipboard"
                  ...
                  <Col lg="3" md="6">
                    <CopyToClipboard
                      ...
                      onCopy={() =>
                        setCopiedText("ni ni-time-alarm")
                      }
                    >
                      <button
                        className="btn-icon-clipboard"
                  ...
                  <Col lg="3" md="6">
                    <CopyToClipboard
                      ...
                      onCopy={() =>
                        setCopiedText("ni ni-umbrella-13")
                      }
                    >
                      <button
                        className="btn-icon-clipboard"
                  ...
                  <Col lg="3" md="6">
                    <CopyToClipboard
                      ...
                      onCopy={() =>
                        setCopiedText("ni ni-watch-time")
                      }
                    >
                      <button
                        className="btn-icon-clipboard"
                  ...
                  <Col lg="3" md="6">
                    <CopyToClipboard
                      ...
                      onCopy={() =>
                        setCopiedText("ni ni-zoom-split-in")
                      }
                    >
                      <button
                        className="btn-icon-clipboard"
                  ...
                  <Col lg="3" md="6">
                    <CopyToClipboard
                      ...
                      onCopy={() =>
                        setCopiedText("ni ni-collection")
                      }
                    >
                      <button
                        className="btn-icon-clipboard"
